...
#+name: make-talker-setup-event-procedure
#+begin_src racket
...
***** [2020-08-20 Thu 10:07]
      ...
      #+begin_src racket
	(define (join-list-of-strings-and-symbols-as-string unjoined-list string-separator)
	  (string-join
	   (map (λ (list-element)
...
#+begin_src racket :mkdirp yes :tangle ~/racket/qtmud/components/talker.rkt
  ...
  <<make-talker-setup-event-procedure>>
